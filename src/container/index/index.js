...
const POST_LIST = [
  {
    ...
    info: 'До біса планувальник, гаймаємо дизайнера і готуємося до презентаціїб як Джобс',
    date: '25.01',
    viewed: false,
  },
  {
    category: [{ text: 'Нова', id: 2 }],
    info: 'Ми хотіли щоб у цьому чаті було  близько 150 людейб щоб зробити якісний пак самопрезентацій',
    date: '25.01',
    viewed: true,
  },
  {
...
const createPost = () => {
  ...
  POST_LIST.forEach((postData) => {
    const post = createElement('div', postData.viewed ? 'post button post--wiewed' : 'post button')
